...
/* Write command */
#define SSD1306_WRITECOMMAND(command)      HAL_I2C_Mem_Write(&SSD1306_I2C_PORT, SSD1306_I2C_ADDR, 0x00, 1, &command, 1, 10)
/* Write data */
#define SSD1306_WRITEDATA(data, size)      HAL_I2C_Mem_Write(&SSD1306_I2C_PORT, SSD1306_I2C_ADDR, 0x40, 1, data, size, 100)
// Display commands
