...
/*Структара, що описує сам сенсор і його параметри*/
typedef struct __VL53L0X
{
    ...
    uint8_t last_status; // Статус останньої транзакції I2C
    ...
    /*У цій функції задається при якій напрузі працює сенсор. 1.8/2.8 В.*/
